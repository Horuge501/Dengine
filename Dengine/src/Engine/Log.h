...
#define LOG(...) Denji::Log::GetLogger()->Print_Log(std::format(__VA_ARGS__),__FILENAME__, __LINE__);
#define INFO(...) Denji::Log::GetLogger()->Print_Info(std::format(__VA_ARGS__), __FILENAME__, __LINE__);
#define ERROR(...) Denji::Log::GetLogger()->Print_Error(std::format(__VA_ARGS__), __FILENAME__, __LINE__);
